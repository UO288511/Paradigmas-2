...
public class Servidor {
	...
	private static void registrarOperaciones(CommServer com) {
		com.addFunction("saluda", (o, x) -> ((SaludadorOOS)o).saluda());
		com.addAction("cambiaSaludo",(o,x) -> ((SaludadorOOS)o).cambiaSaludo((String) x[0]) );
		com.addAction("reset", (o,x)->((SaludadorOOS)o).reset() );
...
//		com.activateMessageLog(); // activa el registro de mensajes del servidor en un archivo
		...
		while (true) { // el servicio siempre ha de estar disponible
			...
			objServicio = new SaludadorOOS("Hola, buenos días, tardes, noches");
